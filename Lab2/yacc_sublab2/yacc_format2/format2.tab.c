...
#ifndef YY_YY_FORMAT2_TAB_H_INCLUDED
# define YY_YY_FORMAT2_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_FORMAT2_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "T_NUMBER", "T_ID", "T_ADD", "T_MINUS",
  "T_MULTIPLY", "T_DIVIDE", "T_LEFT", "T_RIGHT", "UMINUS", "';'",
...
#line 41 "format2.y"
                           { cout<<yyvsp[-1]<<endl; }
#line 1334 "format2.tab.c"
    break;

  case 5:
#line 46 "format2.y"
                            { yyval = yyvsp[-2]; yyval += yyvsp[0]; yyval += "+ "; }
#line 1340 "format2.tab.c"
    break;

  case 6:
#line 47 "format2.y"
                              { yyval = yyvsp[-2]; yyval += yyvsp[0]; yyval += "- "; }
#line 1346 "format2.tab.c"
    break;

  case 7:
#line 48 "format2.y"
                                 { yyval = yyvsp[-2]; yyval += yyvsp[0]; yyval += "* "; }
#line 1352 "format2.tab.c"
    break;

  case 8:
#line 49 "format2.y"
                               { yyval = yyvsp[-2]; yyval += yyvsp[0]; yyval += "/ "; }
#line 1358 "format2.tab.c"
    break;

  case 9:
#line 50 "format2.y"
                                { yyval = yyvsp[-1]; }
#line 1364 "format2.tab.c"
    break;

  case 10:
#line 51 "format2.y"
                                      { yyval = "-"; yyval += yyvsp[0]; yyval += " "; }
#line 1370 "format2.tab.c"
    break;

  case 11:
#line 52 "format2.y"
                     { yyval = yyvsp[0]; yyval += " "; }
#line 1376 "format2.tab.c"
    break;

  case 12:
#line 53 "format2.y"
                 { yyval = yyvsp[0]; yyval += " "; }
#line 1382 "format2.tab.c"
    break;


#line 1386 "format2.tab.c"
