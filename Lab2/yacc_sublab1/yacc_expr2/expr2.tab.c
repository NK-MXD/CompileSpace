...
{
  "$end", "error", "$undefined", "T_NUMBER", "T_ADD", "T_MINUS",
...
#line 1330 "expr2.tab.c"
    break;

  case 6:
#line 40 "expr2.y"
                              { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1336 "expr2.tab.c"
    break;

  case 7:
#line 41 "expr2.y"
                                 { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1342 "expr2.tab.c"
    break;
...
#line 50 "expr2.y"
                     { yyval = yyvsp[0]; }
#line 1370 "expr2.tab.c"
    break;


#line 1374 "expr2.tab.c"
