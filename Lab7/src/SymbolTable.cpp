...
IdentifierSymbolEntry::IdentifierSymbolEntry(Type *type,std::string name, int scope,int paramno,int ident_type) 
    : SymbolEntry(type, ident_type), name(name),scope(scope),paramno(paramno)
{
    //this->scope = 0;
    this->idtype = ident_type;
}
